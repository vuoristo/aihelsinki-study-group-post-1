...
\end{lstlisting}
The gaussian kernel and its amplitude response are shown in the
...
presents the new kernel. The corresponding frequency-based representation shows
that there are more high frequency components retained (bright pixels away from
origin).
\begin{figure}
